...
import org.material.management.service.impl.MaterialInfoServiceImpl;
...
public class MaterialInfoService {
    ...
    public List<MaterialBaseModel> getBaseInfoByParams (Map<String, Object> params) {
        ...
        if (params.containsKey(checkKey)) {
            ...
            Map<String, Object> baseInfoMap = MaterialInfoServiceImpl.splitBaseInfoParams(params, baseInfoKeyList, baseInfoTargetList);
            ...
            Map<String, Object> categoryMap = MaterialInfoServiceImpl.splitCategoryParams(params, categoryKeyList, categoryTargetList);
            ...
            if (materialCatIdList != null) {
                ...
                if (materialCatIdList.size() > 1) {
                    ...
                    Map<String, Object> categoryBaseMap = MaterialInfoServiceImpl.splitBaseInfoParams(params, catBaseKeyList, catBaseKeyList);
            ...
            Map<String, Object> materialMap = MaterialInfoServiceImpl.splitMaterialParams(params, materialKeyList, materialKeyList);
        ...
        for (int i = 1; i < 10; ++i) {
            ...
            switch (i) {
                ...
                case 4:
                    ...
                    break;
                default:
                    List<ControlPropertyBean> controlProps = MaterialInfoServiceImpl.getAllControlPropertyByType(i, orgnizationId, spuCode);
