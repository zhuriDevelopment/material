...
INSERT INTO `materialBase` VALUES (1,'110101','111','自动化机器','自动化生产线使用',1,'','',2,'流水线生产','','2015-12-08 00:00:00',7), \
									(2,'110102','112','人工操作机器','需雇佣工人',2,'','',2,'流水线生产','','2015-12-08 00:00:00',7), \
									(3,'210101','211','棉布','纺织用品',1,'001','v1.0',3,'服装原料','','2015-12-08 00:00:00',8), \
									(4,'210102','212','丝绸','纺织用品',3,'010','v2.0',3,'服装原料','','2015-12-08 00:00:00',8), \
									(5,'310101','311','台式电脑','管理人员使用',4,'','',4,'办公','','2015-12-08 00:00:00',9);
UNLOCK TABLES;

LOCK TABLES `material` WRITE;
INSERT INTO `material` VALUES (1,'110101','M110101-7-000001','自动机器A','旧自动机器A','11010101',1,500000,0), \
								(2,'110101','M110101-7-000002','自动机器B','旧自动机器B','11010102',1,200000,0), \
								(3,'110102','M110102-7-000001','人工机器C','旧人工机器C','11010201',2,100000,0), \
								(4,'210101','M210101-8-000001','棉布一批','旧棉布一批','21010101',3,10000,0), \
								(5,'210101','M210101-8-000002','棉布二批','旧棉布二批','21010102',3,10000,0), \
								(6,'210102','M210102-8-000001','丝绸一批','旧丝绸一批','21010201',4,10000,0), \
								(7,'310101','M310101-9-000001','电脑1','旧电脑1','31010101',5,8000,0), \
								(8,'310101','M310101-9-000002','电脑2','旧电脑2','31010102',5,6000,0);
UNLOCK TABLES;

LOCK TABLES `materialSku` WRITE;
INSERT INTO `materialSku` VALUES (1,'110101','111','蓝翔挖掘机','11101',2,500000,0,20,'备注111'), \
								(2,'110101','112','新东方全自动锅炉','11102',2,200000,0,30,'备注112'), \
								(3,'110102','121','富士康打孔机','11201',2,100000,20,40,'备注121'), \
								(4,'210101','211','红棉布','21101',3,10000,10,20,'备注211'), \
								(5,'210101','212','黑棉布','21102',3,10000,30,40,'备注212'), \
								(6,'210102','221','白丝绸','21201',3,10000,60,100,'备注221'), \
								(7,'310101','311','清华同方电脑','31101',4,8000,9000,12000,'备注311'), \
								(8,'310101','312','美帝良心想','31102',4,6000,90000,6000,'备注312');
UNLOCK TABLES;

LOCK TABLES `unit` WRITE;
INSERT INTO `unit` VALUES 	(1,'无单位','无单位','invalid',0,0,0), \
							(2,'单体','部','one',1,1,1), \
							(3,'长度','米','meter',2,1,1), \
							(4,'单体','台','one',3,1,1);
UNLOCK TABLES;
...
INSERT INTO `materialUnit` VALUES (1,'110101',2,2,1,1), \
									(2,'110102',2,2,1,1), \
									(3,'210101',3,3,1,1), \
									(4,'210102',3,3,1,1), \
									(5,'310101',4,4,1,1);
