...
INSERT INTO `materialBaseProp` VALUES (1,7,4,'规格1','规格1','{\"type\":3,\"upper\":"10",\"lower\":"0"}',1), \
										(2,8,4,'规格1','规格1','{\"type\":3,\"upper\":"10",\"lower\":"0"}',1), \
										(3,9,4,'规格1','规格1','{\"type\":3,\"upper\":"10",\"lower\":"0"}',1);
UNLOCK TABLES;

LOCK TABLES `materialBasePropVal` WRITE;
INSERT INTO `materialBasePropVal` VALUES (1,'110101','11101',1,'规格值'), \
											(2,'110101','11102',1,'规格值'), \
											(3,'110102','11201',1,'规格值'), \
											(4,'210101','21101',2,'规格值'), \
											(5,'210101','21102',2,'规格值'), \
											(6,'210102','21201',2,'规格值'), \
											(7,'310101','31101',3,'规格值'), \
											(8,'310101','31102',3,'规格值'), \
											(9,'110101','-1',1,'规格值'), \
											(10,'110102','-1',1,'规格值'), \
											(11,'210101','-1',2,'规格值'), \
											(12,'210102','-1',2,'规格值'), \
